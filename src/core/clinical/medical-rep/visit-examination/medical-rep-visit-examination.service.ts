        ...
        try {
          const created = await tx.medication.create({
            data: {
              ...
              default_dose_amount: product.default_dose_amount ?? null,
              default_dose_unit: product.default_dose_unit ?? null,
              default_dose_frequency: product.default_dose_frequency ?? null,
              default_dose_route: product.default_dose_route ?? null,
            },
            select: { id: true },
          });
          mid = created.id;
