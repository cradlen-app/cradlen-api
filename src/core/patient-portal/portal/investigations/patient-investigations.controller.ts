...
@Controller({ path: 'patient-portal/investigations', version: '1' })
export class PatientInvestigationsController {
  constructor(
  ...
  @Post(':investigationId/result-upload-url')
  @Public()
  @UseGuards(PatientJwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({
  ...
  @Delete(':investigationId/result/:attachmentId')
  @Public()
  @UseGuards(PatientJwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({
